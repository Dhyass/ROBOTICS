# -*- coding: utf-8 -*-
"""
Created on Wed Dec 20 13:58:50 2023
...
class RobotController:
    ...
    def __init__(self):
        ...
        self.menu_frame = ttk.LabelFrame(self.root, text="CONTROLE DU ROBOT", labelanchor="n", padding=(5, 5), style="My.TLabelframe")
        ...
        self.btn_start = tk.Button(self.menu_frame, text="✔ Démarrer",  command=self.start_robot, background="lime", 
                                   font=bold_font, height=2, width=18, cursor=cursor )
       ...
       # Configuration des boutons avec des marges
        ...
        self.objet_coordonnes_frame = ttk.LabelFrame(self.param_frame, text="COORDONNES ONBJET", labelanchor="n", padding=(10, 10))
        ...
        style.configure("My.TLabelframe", background="white")
        self.object_frame = ttk.LabelFrame(self.rt_frame, text="OBJECT POSE", labelanchor="n", padding=(10, 10), style="My.TLabelframe")
    ...
    def create_objects_pose_widgets(self):
         ...
         self.object_entry = tk.Entry(self.object_frame, justify=justify, font=bold_font, width=width,
                                              textvariable=tk.StringVar(value="None"), fg='gray')
         self.object_button = tk.Button(self.object_frame, text="Trajectory", command=self.connect_to_pi,
                                            background=background, height=height, width=10, font=5, cursor=cursor)
