...
class RobotController:
    ...
    def __init__(self):
        ...
        #  pour initialiser la figure et les axes
    ...
    # Mettre à jour la position actuelle du moteur (simuler le mouvement)
        ...
        # Attendez un court instant pour simuler le mouvement (ajustez selon vos besoins)
        time.sleep(0.1)

    def update_plot(self):
        # Ajoutez ces lignes pour tracer l'historique des erreurs
        self.ax0.clear()
    ...
    def robot_home(self):
        ...
        self.angle_j1.set(60)
        self.angle_j2.set(90.0)
        self.angle_j3.set(90)
        self.angle_j4.set(-60.0)
        self.angle_j5.set(30.0)
